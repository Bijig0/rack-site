      ...
      <div className="row mb30">
        <div className="col-lg-8">
          <div className="single-property-content mb30-md">
            <div className="skeleton-box mb-3" style={{ width: "80%", height: 36 }}></div>
            ...
            <div className="d-flex gap-3">
              <div className="skeleton-box" style={{ width: 60, height: 16 }}></div>
              <div className="skeleton-box" style={{ width: 60, height: 16 }}></div>
              <div className="skeleton-box" style={{ width: 80, height: 16 }}></div>
            </div>
          </div>
        ...
        <div className="col-lg-4">
          <div className="text-lg-end">
            <div className="d-flex gap-2 justify-content-lg-end mb-3">
              <div className="skeleton-box" style={{ width: 30, height: 30 }}></div>
              <div className="skeleton-box" style={{ width: 30, height: 30 }}></div>
            </div>
          ...
          <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 overflow-hidden position-relative">
            <div className="row">
              <div className="col-md-8">
                <div className="skeleton-box" style={{ width: "100%", height: 300, borderRadius: 12 }}></div>
              </div>
              <div className="col-md-4">
                <div className="row g-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="col-6">
                      <div className="skeleton-box" style={{ width: "100%", height: 90, borderRadius: 8 }}></div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <div className="row">
        <div className="col-xl-12">
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="col-sm-6 col-lg-3">
                  <div className="d-flex align-items-center mb25">
                    <div className="skeleton-box me-3" style={{ width: 40, height: 40, borderRadius: "50%" }}></div>
                    <div>
          ...
          <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
            ...
            <div className="skeleton-box" style={{ width: "100%", height: 120 }}></div>
          </div>
        </div>
      </div>
